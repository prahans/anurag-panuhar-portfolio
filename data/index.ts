...
export const workExperience = [
  {
    ...
    desc: "Built and deployed full-stack applications using React, Node.js, Express, MongoDB, and PostgreSQL.",
...

  {
    ...
    desc: "Developed REST APIs, authentication flows, database models, middleware, and server-side application logic.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },

  {
    ...
    desc: "Created responsive interfaces with React, TypeScript, React Query, and modern component-based architecture.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },

  {
    ...
    desc: "Deployed applications using Vercel, Render, and Netlify while debugging real production and build issues.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
